...
static const u8 my_devName[] = {'M','A','O','W','A','T','C','H'};
...
//////////////////////// Minimal HID keyboard /////////////////////////////////
static const u16 my_hidServiceUUID = SERVICE_UUID_HUMAN_INTERFACE_DEVICE;
static const u16 my_hidInfoUUID = CHARACTERISTIC_UUID_HID_INFORMATION;
static const u16 my_hidReportMapUUID = CHARACTERISTIC_UUID_HID_REPORT_MAP;
static const u16 my_hidProtocolModeUUID = CHARACTERISTIC_UUID_HID_PROTOCOL_MODE;
static const u16 my_hidReportUUID = CHARACTERISTIC_UUID_HID_REPORT;
static const u16 my_hidControlPointUUID = CHARACTERISTIC_UUID_HID_CONTROL_POINT;
static const u8 my_hidInfo[] = {0x11, 0x01, 0x00, 0x02};
static const u8 my_hidReportMap[] = {
...
static u8 my_hidProtocolMode = HID_PROTOCOL_MODE_REPORT;
static u8 my_hidInputReport[9] = {1, 0, 0, 0, 0, 0, 0, 0, 0};
static u8 my_hidInputReportCCC[2];
static const u8 my_hidInputReportRef[] = {1, HID_REPORT_TYPE_INPUT};
static u8 my_hidControlPoint;
...
static const u8 my_hidInfoCharVal[5] = {
	CHAR_PROP_READ, U16_LO(HID_INFO_DP_H), U16_HI(HID_INFO_DP_H),
...
static const u8 my_hidInputReportCharVal[5] = {
	CHAR_PROP_READ | CHAR_PROP_NOTIFY,
	U16_LO(HID_INPUT_REPORT_DP_H), U16_HI(HID_INPUT_REPORT_DP_H),
	U16_LO(CHARACTERISTIC_UUID_HID_REPORT), U16_HI(CHARACTERISTIC_UUID_HID_REPORT)
};
static const u8 my_hidControlPointCharVal[5] = {
...
static const attribute_t my_Attributes[] = {
	...
	////////////////////////////////////// HID ////////////////////////////////////////////////////////
	{13,ATT_PERMISSIONS_READ,2,2,(u8*)(&my_primaryServiceUUID),(u8*)(&my_hidServiceUUID),0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidInfoCharVal),(u8*)(&my_characterUUID),(u8*)my_hidInfoCharVal,0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidInfo),(u8*)(&my_hidInfoUUID),(u8*)my_hidInfo,0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidReportMapCharVal),(u8*)(&my_characterUUID),(u8*)my_hidReportMapCharVal,0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidReportMap),(u8*)(&my_hidReportMapUUID),(u8*)my_hidReportMap,0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidProtocolModeCharVal),(u8*)(&my_characterUUID),(u8*)my_hidProtocolModeCharVal,0},
	{0,ATT_PERMISSIONS_RDWR,2,sizeof(my_hidProtocolMode),(u8*)(&my_hidProtocolModeUUID),&my_hidProtocolMode,0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidInputReportCharVal),(u8*)(&my_characterUUID),(u8*)my_hidInputReportCharVal,0},
	{0,ATT_PERMISSIONS_ENCRYPT_READ,2,sizeof(my_hidInputReport),(u8*)(&my_hidReportUUID),my_hidInputReport,0},
	{0,ATT_PERMISSIONS_ENCRYPT_RDWR,2,sizeof(my_hidInputReportCCC),(u8*)(&clientCharacterCfgUUID),my_hidInputReportCCC,0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidInputReportRef),(u8*)(&reportRefUUID),(u8*)my_hidInputReportRef,0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(my_hidControlPointCharVal),(u8*)(&my_characterUUID),(u8*)my_hidControlPointCharVal,0},
	{0,ATT_PERMISSIONS_ENCRYPT_WRITE,2,sizeof(my_hidControlPoint),(u8*)(&my_hidControlPointUUID),&my_hidControlPoint,0},
};
