...
typedef enum
{
	...
	//// HID keyboard test profile ////
	HID_PS_H,
	HID_INFO_CD_H,
	HID_INFO_DP_H,
	HID_REPORT_MAP_CD_H,
	HID_REPORT_MAP_DP_H,
	HID_PROTOCOL_MODE_CD_H,
	HID_PROTOCOL_MODE_DP_H,
	HID_INPUT_REPORT_CD_H,
	HID_INPUT_REPORT_DP_H,
	HID_INPUT_REPORT_CCB_H,
	HID_INPUT_REPORT_REF_H,
	HID_CONTROL_POINT_CD_H,
